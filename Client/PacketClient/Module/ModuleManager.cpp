...
void ModuleManager::initModules() {
	{
		...
		moduleList.push_back(std::shared_ptr<IModule>(new Wtap()));
		moduleList.push_back(std::shared_ptr<IModule>(new AutoAim()));
		...
		moduleList.push_back(std::shared_ptr<IModule>(new Detector()));
